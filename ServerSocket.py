...
s.bind(('192.168.1.7', 12345)) #bind creates one unique address which is built up from both the ip address and port number.
s.listen(1)
blinkled()
...
while True:
    ...
    connection.sendall("This is the server")
